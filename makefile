Msuite: bin/preprocessor.pe bin/preprocessor.se bin/bowtie2.processer.pe bin/bowtie2.processer.se bin/rmdup.pe bin/rmdup.se bin/meth.caller util/bed2wig util/extract.meth.in.region
...
bin/preprocessor.pe: src/preprocessor.pe.cpp src/common.h
	$(cc) $(options) $(multithread) -o bin/preprocessor.pe src/preprocessor.pe.cpp
...
bin/meth.caller: src/meth.caller.cpp src/common.h
	$(cc) $(options) -o bin/meth.caller src/meth.caller.cpp
...
clean:
	rm -f bin/preprocessor.pe bin/preprocessor.se bin/bowtie2.processer.pe bin/bowtie2.processer.se bin/rmdup.pe bin/rmdup.se bin/meth.caller util/bed2wig util/extract.meth.in.region
